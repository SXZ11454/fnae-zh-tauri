...
| 位置 | 改动内容 |
|------|---------|
| **§📦 版本特性** | 「触屏旋转按钮」改为明确说明左下角/右下角各有按钮；新增「教程移至主菜单」一条 |
| **§2 操作表** | 旋转方式改为「左下角·右下角旋转按钮」；作弊菜单改为「右上角直接点击打开」；新增「查看教程」行并注明需到主菜单查阅 |
| **§3 游戏流程** | 顶部加 ⚠️ 提示框说明教程不自动弹出；删除第 1/2/3 夜的「教程（…）」特殊事件描述 |
| **§5.1 爱泼斯坦** | 删除「教学用途」括号注释 |
| **§5.2 特朗普** | 删除「不播放任何音效」括号注释，简化撤退描述 |
| **§5.3 霍金** | 删除「独特的"导弹式"动画——伴随爆炸特效」一句 |
| **§6.3 摄像头** | 删除「伴随曲柄音效」 |
| **§6.4 控制面板** | 删除「伴随心电图音效」 |

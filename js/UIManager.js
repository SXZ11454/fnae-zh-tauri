...
class UIManager {
    ...
    createControlPanelPopup() {
        ...
        popup.style.fontFamily = "'Consolas', 'Courier New', sans-serif";
        ...
        option1.innerHTML = this.game.state.ventsClosed ? 
            '<span class="option-arrow" style="color: #0f0; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>打开通风口</span><span id="vents-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Consolas\', \'Courier New\', sans-serif;"></span>' :
            '<span class="option-arrow" style="color: #0f0; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>关闭通风口</span><span id="vents-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Consolas\', \'Courier New\', sans-serif;"></span>';
        ...
        option2.style.cursor = 'default';
        option2.style.padding = '1.5vh 0';
        option2.style.display = 'flex';
        option2.style.alignItems = 'center';
        option2.style.direction = 'ltr'; // 强制从左到右
        option2.innerHTML = '<span class="option-arrow" style="color: transparent; margin-right: 1.5vw; width: 2vw;">&gt;</span><span>重启摄像头</span><span id="camera-dots" style="margin-left: 1vw; direction: ltr; font-family: \'Consolas\', \'Courier New\', sans-serif;"></span><span id="camera-status" style="margin-left: auto; padding-right: 2vw; direction: ltr;"></span>';
    ...
    updateHotspotVisibility(viewPosition) {
        // 控制面板按钮和摄像头按钮是独立的，始终可见可用，不再受视角位置限制
        const ventsBtn = document.getElementById('vents-btn');
        const cameraBtn = document.getElementById('camera-btn');
        if (ventsBtn) {
            ventsBtn.style.opacity = '1';
            ventsBtn.style.pointerEvents = 'auto';
        }
        if (cameraBtn) {
